...
''' The subdirectory in the app's template directory. Used to avoid
collisions with other app's similarly named template files.
'''
...
''' The standard template context that will be passed on to the
